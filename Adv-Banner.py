...
def banner():
	logo()
	menu = ["\n\t\t\033[93m\033[40m[1] EvilEye Banner  (Normal)\033[49m\n",
		"\t\t\033[93m\033[40m[2] EvilEye Banner  (Animation)\033[49m\n",
		"\t\t\033[93m\033[40m[3] Custom Banner   (Normal)\033[49m\n",
		"\t\t\033[93m\033[40m[4] Custom Banner   (Animation)\033[49m\n",
		"\t\t\033[93m\033[40m[5] Neofetch Banner (Normal)\033[49m\n",
		"\t\t\033[93m\033[40m[6] Neofetch Banner (Animation)\033[49m\n",
		"\t\t\033[93m\033[40m[7] Help            (banners information)\033[49m\n",
		"\t\t\033[93m\033[40m[8] Main Menu\033[49m\n\n",
		"\033[94mEnter Your Choice: "]
	for men in menu:
		for me in men:
			print(me, end='')

...
def banner():
	...
	if bc == 1:
		...
		with open("bash.bashrc" ,"w") as bash:
			bash.write("echo && lolcat --spread=1 --speed=100 /data/data/com.termux/files/usr/etc/dvsbanner && echo && neofetch --source /data/data/com.termux/files/usr/etc/banner | lolcat && PS1=\"$ \"")
		with open("zshrc" ,"w") as zsh:
		...
		os.system("nano banner")
		with open("bash.bashrc" ,"w") as bash:
			bash.write("echo && lolcat -a --spread=1 --speed=100 /data/data/com.termux/files/usr/etc/dvsbanner && echo && neofetch --source /data/data/com.termux/files/usr/etc/banner | lolcat -a --spread=1 --speed=100 && PS1=\"$ \"")
		with open("zshrc" ,"w") as zsh:
